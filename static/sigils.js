...
const CLASS_EMBLEMS = {
  soldat: svg(`
    ...
    <polygon points="78,22 84,16 78,28 72,22" ${FILL}/>
...
const SIGILS = {
  atac: svg(`<polygon points="52,10 24,52 44,52 36,90 70,42 50,42 60,10" ${FILL}/>`),
  magie: svg(`
...
// ====== SMALL UI ICONS ======
const ICONS = {
  hp: svg(`<path d="M 50 84 C 14 60 14 30 30 22 C 42 18 50 28 50 36 C 50 28 58 18 70 22 C 86 30 86 60 50 84 Z" ${FILL}/>`),
  energy: svg(`
  ...
  `),
  shield: svg(`<polygon points="50,12 82,28 82,56 50,86 18,56 18,28" ${FILL}/>`),
  flourish: svg(`
